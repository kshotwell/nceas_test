...
Write a bunch of text in here. We will use R Markdown [@RMarkdown]
...
where $x$ is something on populations $x+y$ is somthing else

Equations need to be escaped when using latex
...
access to a lot of computational machinery can refer to parameters and results
